...
UNKNOWN_INFO_PHRASES = (
    "معندناش معلومات", "معنديش معلومات", "مش عندنا معلومات",
    "مش عارف", "مش متوفر", "لا توجد معلومات", "لا أعرف",
    "don't have that information", "do not have that information",
    "not available", "i don't know",
)
...
UNKNOWN_INFO_REPLY = (
    ...
    "• للتواصل مع إدارة الحضانة مباشرةً، تقدر تتصل على الرقم ده   👇"
)
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if choices and "message" in choices[0]:
                    ...
                    if bot_reply:
                        # IMPORTANT: detect the explicit marker BEFORE reflection,
                        # so the reflection model cannot turn an unknown answer
                        # into an invented answer.
                        if "[[CONTACT_ADMIN]]" in bot_reply or is_unknown_info_reply(bot_reply):
                        ...
                        # Also protect against the reflection model deciding that
